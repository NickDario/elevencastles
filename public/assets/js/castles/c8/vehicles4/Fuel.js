...
define(['etc/VectorND', 'c8/vehicles4/Genome'], function(Vector, Genome){
    ...
    Fuel.prototype.init = function()
    {
        ...
        this._initIdentity();
        this.nutrition = this.getGene('radius') * this.getGene('nutrition');
        this.cost = this.nutrition/this.getGene('growthRate');
    };
